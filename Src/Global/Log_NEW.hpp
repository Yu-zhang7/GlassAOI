...
#define FILE_LOG_TRACE(...) FileLogPrintf(__VA_ARGS__)
#define FILE_LOG_DEBUG(...) FileLogPrintf(__VA_ARGS__)
#define FILE_LOG_INFO(...) FileLogPrintf(__VA_ARGS__)
#define FILE_LOG_WARN(...) FileLogPrintf(__VA_ARGS__)
#define FILE_LOG_ERROR(...) FileLogPrintf(__VA_ARGS__)
#define FILE_LOG_CRITICAL(...) FileLogPrintf(__VA_ARGS__)
